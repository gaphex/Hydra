...
class API(object):
    ...
    def __init__(self, key, host='catalog.api.dugis.ru', version='1.3', register_views=True):
        """
    ...
    http://api.dugis.ru/doc/firms/list/project-list/
    """
    project_list = bind_api(path='/project/list', allowed_param=[],)

    """List of the project cities

    http://api.dugis.ru/doc/firms/list/city-list/
    """
    city_list = bind_api(path='/city/list', allowed_param=['where', 'project_id'])

    def rubricator(self, **kwargs):
        """Rubrics search

        http://api.dugis.ru/doc/firms/list/rubricator/
        """
    ...
    def search(self, **kwargs):
        ...
        http://api.dugis.ru/doc/firms/searches/search/
        """
    ...
    def search_in_rubric(self, **kwargs):
        ...
        http://api.dugis.ru/doc/firms/searches/searchinrubric/
        """
    ...
    http://api.dugis.ru/doc/firms/searches/firmsbyfilialid/
    """
    ...
    http://api.dugis.ru/doc/firms/searches/adssearch/
    """
    ads_search = bind_api(
        path='/ads/search',
    ...
    http://api.dugis.ru/doc/firms/profiles/profile/
    """
    profile = bind_api(
        path='/profile',
    ...
    def geo_search(self, **kwargs):
        ...
        http://api.dugis.ru/doc/geo/search/
        """
